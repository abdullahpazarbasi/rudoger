const titles: Record<string, string> = {
  ...
  "packaging-not-found": "İstenen packaging kaydı bulunamadı.",
  ...
  "stock-item-not-found": "Bu ürün için stok kaydı bulunamadı.",
  ...
  "stock-source-event-id-required": "Stok hareketi kaynak olay kimliği zorunludur.",
